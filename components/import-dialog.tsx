...
import { parseCSV, validateImportData, generateSampleCSV, type ImportResult } from "@/utils/file-parser"
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  className="mt-1"
                />
                <p className="text-sm text-muted-foreground mt-1">Supported formats: CSV (.csv, .txt)</p>
              </div>
          ...
          <TabsContent value="template" className="space-y-6">
            <div className="space-y-4">
              <Alert>
                <FileText className="h-4 w-4" />
                <AlertDescription>
                  Download a sample CSV template to see the required format for importing inventory data.
                </AlertDescription>
              </Alert>
