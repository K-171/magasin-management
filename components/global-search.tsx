...
export function GlobalSearch() {
  ...
  return (
    <div className="relative" ref={searchRef}>
      ...
      <Input
        className="pl-10 pr-4 py-2 w-80 border border-input rounded-full focus:outline-none focus:ring-2 focus:ring-ring bg-background text-foreground"
      ...
      {isOpen && results.length > 0 && (
        <div className="absolute mt-2 w-full bg-popover border border-border rounded-lg shadow-lg z-10 max-h-96 overflow-y-auto">
          <ul>
